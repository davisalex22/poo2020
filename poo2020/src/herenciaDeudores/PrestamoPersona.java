...
public class PrestamoPersona extends Deudores {
    // Declaración de variables
    private double interesPagar;
    private double anios;

    /**
     * Método Constructor clase PrestamoPersona
     * @param nombreD
     * @param numeroCuenta
     * @param capitalPrestamo
     * @param anios
     */
    public PrestamoPersona(String nombreD,String numeroCuenta,double capitalPrestamo,int anios){
