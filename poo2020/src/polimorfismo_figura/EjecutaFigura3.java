        ...
        while (nuevaFigura == 0) {
            ...
            switch (condicion){
                case 0:
                    ...
                    rectangulo3.setAlturaRecta(Double.parseDouble(JOptionPane.showInputDialog("Ingrese la altura del rectangulo")));
                    rectangulo3.setBaseRecta(Double.parseDouble(JOptionPane.showInputDialog("Ingrese la base del rectángulo")));
                    rectangulo3.calcularArea();
                    JOptionPane.showMessageDialog(null, String.format("El área del rectángulo es: %.2f",rectangulo3.getArea()));
                    break;
                case 1:
                    ...
                    JOptionPane.showMessageDialog(null, String.format("El área del circulo es: %.2f",circulo3.getArea()));
                    break;
                case 2:
                    Cuadrado3 cuadrado3 = new Cuadrado3();
                    JOptionPane.showMessageDialog(null, "Cálculo del área del cuadrado");
                    cuadrado3.setLadoCuadrado(Double.parseDouble(JOptionPane.showInputDialog("Ingrese el lado del cuadrado")));
                    cuadrado3.calcularArea();
                    JOptionPane.showMessageDialog(null, String.format("El área del cuadrado es: %.2f",cuadrado3.getArea()));
                    break;
                case 3:
                    Triangulo3 triangulo3 = new Triangulo3();
                    JOptionPane.showMessageDialog(null, "Cálculo del área del triángulo");
                    triangulo3.setAlturaTrian(Double.parseDouble(JOptionPane.showInputDialog("Ingrese la altura del triángulo")));
                    triangulo3.setBaseTrian(Double.parseDouble(JOptionPane.showInputDialog("Ingrese la base del triángulo")));
                    triangulo3.calcularArea();
                    JOptionPane.showMessageDialog(null, String.format("El área del triángulo es: %.2f",triangulo3.getArea()));
                    break;
                default:
                    System.out.println("Erro de Selección");
            }
